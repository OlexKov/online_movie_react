  ...
  return (
   <>
    ...
    <div className="about-container text-center">
        <h2>Ласкаво просимо до на наш сайт</h2>
        <p>Ми прагнемо пропонувати вам найкращі фільми для вашої розваги. Ознайомтеся з нашою колекцією та насолоджуйтеся враженнями від кіно, не виходячи з дому.</p>
        <h2>Рекомендуємо</h2>
